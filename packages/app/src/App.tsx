...
// import { VeecodeAssistantAiPage } from '@veecode-platform/backstage-plugin-veecode-assistant-ai';
...
const routes = (
  <FlatRoutes>
    ...
    {/* <Route path="/veecode-assistant-ai" element={<VeecodeAssistantAiPage />} /> */}
  </FlatRoutes>
);
