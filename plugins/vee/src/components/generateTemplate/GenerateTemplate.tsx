...
import { useGenerateTemplateStyles } from './styles';
// import { useVeeContext } from '../../context';
import { GenerateTemplateProps } from './types';
import { InstructionsProps } from 'utils/types';
import  TextareaAutosize from '@mui/material/TextareaAutosize';

export const GenerateTemplate : React.FC<GenerateTemplateProps> = (props) => {
 ...
 //  const { createTemplate } = useVeeContext()
  const { input, root, textareaStyles } = useGenerateTemplateStyles();
